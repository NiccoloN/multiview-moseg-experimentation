...
%la funzione, per un tipo di modello cerca M ipotesi non degeneri. Per
%ognuna di queste, usa il numero minimo di punti prendendoli a caso tra
%quelli disponibili, finchè non trova un subset di punti che renodono
%il modello non degenere (o ficnhè non esaurisce il numero di tentativi)
