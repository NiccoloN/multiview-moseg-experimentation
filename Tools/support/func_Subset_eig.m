...
%
%
function [U_Subset,itr,loss,exitinfo,RedLapTrace] = func_Subset_eig(K,nMotion,gamma,epsilon,MaxItr)
...
for k_i = 1:nKernel
    U_Subset_Normalized = U_All_Normalized(:,(k_i-1)*nMotion+1:k_i*nMotion);
    RedLapTrace = RedLapTrace + trace(U_Subset_Normalized'*L_tilde(:,:,k_i)*U_Subset_Normalized);
end
